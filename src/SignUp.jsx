...
export default function SignUp() {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            // Store success message and email in sessionStorage for the Login page
            sessionStorage.setItem('signup_success_message', 'Account created successfully! Please check your email to verify your account before signing in.');
    ...
    return (
        <div style={styles.container}>
            <form onSubmit={handleSignUp} style={styles.form}>
                ...
                <p onClick={() => window.location.href = "/login"} style={styles.toggle}>
