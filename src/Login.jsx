...
export default function Login() {
    ...
    useEffect(() => {
        ...
        const storedMessage = sessionStorage.getItem('signup_success_message');
        if (storedEmail) {
        ...
        if (storedMessage) {
            ...
            sessionStorage.removeItem('signup_success_message');
        }
    }, []);
    ...
    useEffect(() => {
        if (successMessage) {
            const timer = setTimeout(() => {
                setSuccessMessage('');
            }, 6000); // Automatically clears after 6 seconds
    ...
    return (
        <div style={styles.container}>
            <form onSubmit={handleLogin} style={styles.form}>
                ...
                <p onClick={() => window.location.href = "/signup"} style={styles.toggle}>
